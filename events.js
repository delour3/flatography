...
======================================== */		
	...
	checkSquare(tp, sqr) {
			let sqrRange = [
				["0С", [20, 25, 35, 45, 55, 1000]],
				["1С", [35, 45, 55, 65, 80, 1000]],
				["2С", [55, 65, 75, 90, 105, 1000]],
				["3С", [75, 85, 100, 115, 135, 1000]],
				["4С", [100, 115, 130, 150, 175, 1000]],
			];
			
			let sqrRange2 = ["XS", "S", "M", "L", "XL", "Oversize"];
	...
	getCoordinate(typeOf, value) {
		if (typeOf == "X") {
			let array = ["XS", "S", "M", "L", "XL", "Oversize"];
